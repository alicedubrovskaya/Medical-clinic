        ...
        <ul class="list-group">
            <c:forEach var="appointment" items="${appointments}" varStatus="status">
                <li class="list-group-item">
                    ...
                    <div class="form-group row">
                        <label for="specialization" class="col-sm-2 col-form-label">${doctor_specialization}:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="medicalReport" class="col-sm-2 col-form-label">${doctor_medicalReport}:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="recommendation" class="col-sm-2 col-form-label">${doctor_recommendations}:</label>
                        <div class="col-sm-10">
